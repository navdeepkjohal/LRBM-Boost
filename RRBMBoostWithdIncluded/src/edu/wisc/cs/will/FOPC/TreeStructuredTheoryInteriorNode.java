...
public class TreeStructuredTheoryInteriorNode extends TreeStructuredTheoryNode {
	...
	Map<String,Double>  				regressionMapIfLeaf; // Added By Navdeep Kaur
	...
	public void setRegressionMapIfLeaf(Map<String,Double> regressionVectorIfLeaf) {
		this.regressionMapIfLeaf = regressionVectorIfLeaf;
	}
	
	public Map<String,Double> getRegressionMapIfLeaf(){
		return regressionMapIfLeaf;
	}
}
