...
public class CommandLineArguments {
    ...
    // Introduced By Navdeep Kaur
    // Used to activate RRBM-boost
    
	public static final String useRBM = "rbm";
	private boolean learnRBM=false;
  ...
  //Changed By Navdeep Kaur for RBM check
    public boolean isLearnRBM() {
	        return learnRBM;
    }
       
    public void setLearnRBM(boolean learnRBM) {
        this.learnRBM = learnRBM;
    }
